...
sorted_data_2023.reset_index(drop=True, inplace=True)
...
table_html = f'<div id="table1" style="overflow-x: auto;">{top_5_employees_2023.to_html(classes="table table-bordered table-hover")}</div>'
